...
def implement_compare_models(prompt):
    ...
    llama_3_3_model = implement_llama_3_3_model()
    dct[llama_4_model] = implement_query_model(llama_4_model, prompt)
    dct[llama_3_3_model] = implement_query_model(llama_3_3_model, prompt)
    return dct
