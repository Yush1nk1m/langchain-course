...
def get_product_price(product: str) -> float:
    """Look up the price of a product({laptop,headphones,keyboard}) in the catalog."""
...
def apply_discount(price: float, discount_tier: str) -> float:
    """Apply a discount tier({bronze,silver,gold}) to a price and return the final price."""
    print(
...
# Difference 2: Without @tool, we must MANUALLY define the JSON schema for each fuction
